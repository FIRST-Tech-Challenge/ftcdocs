...
Robot and Driver Station Self-Inspect
-------------------------------------

This section is here to help teams prepare for :term:`inspection <Inspection>` at their events.
Aside from making sure that your robot is within the Maximum Starting Size,
ensuring that your robot code can correctly pass Robot Inspection, and other
tasks in the `Robot Inspection Checklist
...
correctly. There is a tool within the :term:`Driver Station App` 3-dot menu called
the ":term:`Self-Inspect`" feature that can help teams perform a quick check to
...
Automatic Auto to Driver Control Program Switching
--------------------------------------------------

Did you know that it's possible for the :term:`Driver Station` to
...
Loading a Driver Controlled Op Mode>` as soon as your :term:`Autonomous` :term:`OpMode` has
...
let the Driver Station queue up your Driver Controlled OpMode for you! You
...
.. tip::
   The Driver Station App also has a built-in Practice Timer to help your team
   rehearse :term:`match <Match>` timing. See :ref:`FTC Driver Station Practice Timer
   <tech_tips/tech-tips/tech-tip-practice-timer/tech-tip-practice-timer:FTC Driver Station Practice Timer>`.

Got any questions about getting ready for your event? Come start or join the
