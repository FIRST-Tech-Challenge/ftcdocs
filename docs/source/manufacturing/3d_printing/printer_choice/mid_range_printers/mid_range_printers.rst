...
* 4-color multicolor capability built in on the printer
...
* Camera with AI intelligent detection and time-lapse support, filament runout sensor, and clog detection
...
* Multicolor workflows generally add setup complexity and can increase print time/material waste depending on part design
...
.. image:: images/centauricarbon2.png
  :alt: An Elegoo Centauri Carbon 2 Combo 3D printer.
...
* Sensors and safety features: filament sensor, load cell sensor, and power panic
...
.. image:: images/bambulabp2s.jpg
  :alt: A Bambu Lab P2S 3D printer.
