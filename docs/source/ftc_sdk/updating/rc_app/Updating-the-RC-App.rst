...
Controller App is the application that runs on the :term:`Robot Controller` Android
Device (REV :term:`Control Hub` or an Android RC phone). This app
...
.. dropdown:: Robot Controller (RC) app on REV Control Hub
   ...
   #. Manage page on :term:`Driver Hub` or DS phone
