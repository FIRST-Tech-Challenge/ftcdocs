...
- Choose a location on the robot where the radio waves traveling to or from the phone or Control Hub will not be disrupted by electromagnetic interference that could potentially be generated by a 12V :term:`DC motor <DC Motor>`.
