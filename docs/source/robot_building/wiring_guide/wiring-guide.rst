...
from moving or shaking loose during a :term:`match <Match>`. It is best to run wires
...
- Choose a location on the robot where the radio waves traveling to or from the Control Hub or phone will not be blocked/reflected by large pieces of metal or by a 12V battery or a motor.
- Choose a location on the robot where the radio waves traveling to or from the Control Hub or phone will not be disrupted by electromagnetic interference that could potentially be generated by a 12V :term:`DC motor <DC Motor>`.
...
the Driver Station phone, :term:`USB hub <USB Hub>`, and game controller connectors to a
...
careful physical :term:`inspection <Inspection>` of the connection. Check to make sure the
...
1. Remove the :term:`fuse <Fuse>` from the battery.
...
devices work using 5V logic levels. If you would like to use a 5V :term:`I2C`
