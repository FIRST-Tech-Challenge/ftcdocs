...
A :term:`servo <Servo>` is a type of device that takes a Pulse-Width Modulated (:term:`PWM`) signal as 
...
generated by a REV :term:`Hub` (either by a :term:`Control Hub` or :term:`Expansion Hub`) which itself
